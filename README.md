...
1.1.1. Микросервисы как функции AWS Lambda на Java, Node.js приложение как сервер Бэк-энд, React приложение как  Фронт-энд.
...
1.2.2. Исключения, связанные с неисправностями  приложения, должны быть настроены в CloudWatch как тревоги с последующей отправкой писем/SMS соответствующему техническому персоналу.
...
1.2.4. Приложение должно предоставлять пользователю фронта панель мониторинга со всеми тревогами и исключениями данных.

1.2.4.1. Рассмотреть использование polling .
...
1.2.4.1.2. React приложение  Фронт-энд периодически опрашивает Node.js для получения ошибок, а Node.js получает данные из внешней базы данных.
...
1.3.2.4.1. Лучший вариант – HTTP Only Cookies, отправляемые сервером Бэк-энд.
